...
/**
 * ActiveRecord class for table "articles_citations";
 * Table contains linked data for ArticleJournal (one-to-many; citations descriptions);
 *
 * @property int $id
...
class Citations extends ActiveRecord implements LinkedRecordsInterface
{
    ...
    {
        return 'articles_journals_citations';
    } // end function
